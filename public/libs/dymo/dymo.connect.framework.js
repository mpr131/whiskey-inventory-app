...
goog.addDependency = function(e, o, t, r) {
    if (goog.DEPENDENCIES_ENABLED) {
        for (var g, n, i = e.replace(/\\/g, "/"), s = goog.dependencies_, a = 0; g = o[a]; a++)
            s.nameToPath[g] = i,
            s.pathIsModule[i] = !!r;
        for (var l = 0; n = t[l]; l++)
            i in s.requires || (s.requires[i] = {}),
            s.requires[i][n] = !0
    }
}
,
...
goog.allDepsAreAvailable_ = function(e) {
    ...
    if (e && e in goog.dependencies_.requires)
        for (var o in goog.dependencies_.requires[e])
            if (!goog.isProvided_(o) && !goog.isDeferredModule_(o))
                return !1;
    return !0
}
,
goog.maybeProcessDeferredPath_ = function(e) {
    var o;
    e in goog.dependencies_.deferred && (o = goog.dependencies_.deferred[e],
    delete goog.dependencies_.deferred[e],
    goog.globalEval(o))
}
,
goog.loadModule = function(e) {
    var o, t = goog.moduleLoaderState_;
    try {
        ...
        if (goog.moduleLoaderState_.declareLegacyNamespace ? goog.constructNamespace_(r, o) : goog.SEAL_MODULE_EXPORTS && Object.seal && Object.seal(o),
        goog.loadedModules_[r] = o,
        goog.moduleLoaderState_.declareTestMethods)
            for (var g in o)
                0 !== g.indexOf("test", 0) && "tearDown" != g && "setUp" != g && "setUpPage" != g && "tearDownPage" != g || (goog.global[g] = o[g])
    } finally {
...
goog.writeScriptTag_ = function(e, o) {
    if (goog.inHtmlDocument_()) {
        ...
        return void 0 === o ? r ? (r = " onreadystatechange='goog.onScriptLoad_(this, " + ++goog.lastNonModuleScriptIndex_ + ")' ",
        t.write('<script type="text/javascript" src="' + e + '"' + r + "><\/script>")) : goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING ? goog.appendScriptSrcNode_(e) : goog.writeScriptSrcNode_(e) : t.write('<script type="text/javascript">' + o + "<\/script>"),
        !0
    }
    return !1
}
...
goog.writeScripts_ = function() {
    ...
    for (e = 0; e < r.length; e++) {
        if (!(o = r[e]))
            throw goog.moduleLoaderState_ = t,
            Error("Undefined script input");
        n.pathIsModule[o] ? goog.importModule_(goog.basePath + o) : goog.importScript_(goog.basePath + o)
    }
    goog.moduleLoaderState_ = t
}
,
...
goog.retrieveAndExecModule_ = function(e) {
    if (!COMPILED) {
        ...
        goog.IS_OLD_IE_ ? (goog.dependencies_.deferred[o] = r,
        goog.queuedModules_.push(o)) : t(e, r)
    }
}
,
...
goog.globalEval = function(e) {
    if (goog.global.execScript)
        ...
        var o, t;
        null == goog.evalWorksForGlobals_ && (goog.global.eval("var _et_ = 1;"),
        void 0 !== goog.global._et_ ? (delete goog.global._et_,
        goog.evalWorksForGlobals_ = !0) : goog.evalWorksForGlobals_ = !1),
        goog.evalWorksForGlobals_ ? goog.global.eval(e) : ((t = (o = goog.global.document).createElement("SCRIPT")).type = "text/javascript",
        t.defer = !1,
...
goog.getCssName = function(e, o) {
    ...
    var t = goog.cssNameMapping_ ? "BY_WHOLE" == goog.cssNameMappingStyle_ ? g : function(e) {
...
goog.getMsg = function(e, t) {
    return e = t ? e.replace(/\{\$([^}]+)}/g, function(e, o) {
        return o in t ? t[o] : e
    }) : e
}
,
...
goog.base = function(e, o, t) {
    ...
    for (var i = new Array(arguments.length - 2), n = 2; n < arguments.length; n++)
        i[n - 2] = arguments[n];
    for (var s = !1, a = e.constructor; a; a = a.superClass_ && a.superClass_.constructor)
        if (a.prototype[o] === r)
            s = !0;
        else if (s)
            return a.prototype[o].apply(e, i);
    if (e[o] === r)
...
goog.debug.Error = function(e) {
    var o;
    Error.captureStackTrace ? Error.captureStackTrace(this, goog.debug.Error) : (o = (new Error).stack) && (this.stack = o),
...
goog.string.truncateMiddle = function(e, o, t, r) {
    ...
    r && e.length > o ? (g = e.length - (r = o < r ? o : r),
    e = e.substring(0, o - r) + "..." + e.substring(g)) : e.length > o && (r = Math.floor(o / 2),
    g = e.length - r,
...
goog.string.padNumber = function(e, o, t) {
    t = goog.isDef(t) ? e.toFixed(t) : String(e),
    e = t.indexOf(".");
    return -1 == e && (e = t.length),
    goog.string.repeat("0", Math.max(0, o - e)) + t
}
,
...
goog.string.toTitleCase = function(e, o) {
    o = (o = goog.isString(o) ? goog.string.regExpEscape(o) : "\\s") ? "|[" + o + "]+" : "",
...
: function(e, o, t) {
    t = null == t ? e.length - 1 : t;
    if (t < 0 && (t = Math.max(0, e.length + t)),
    goog.isString(e))
...
: function(e, o, t) {
    for (var r, g = e.length, n = [], i = 0, s = goog.isString(e) ? e.split("") : e, a = 0; a < g; a++)
        a in s && (r = s[a],
        o.call(t, r, a, e) && (n[i++] = r));
    return n
}
,
...
goog.array.remove = function(e, o) {
    ...
    return (o = 0 <= t) && goog.array.removeAt(e, t),
    o
}
,
...
goog.array.binaryInsert = function(e, o, t) {
    ...
    return t < 0 && (goog.array.insertAt(e, o, -(t + 1)),
    !0)
}
,
    ...
    for (var o = [], t = 0; t < arguments.length; t++) {
        ...
        if (goog.isArray(r))
            for (var g = 0; g < r.length; g += 8192)
                for (var n = goog.array.slice(r, g, g + 8192), i = goog.array.flatten.apply(null, n), s = 0; s < i.length; s++)
                    o.push(i[s]);
        else
            o.push(r)
    }
...
goog.labs.userAgent.engine.getVersion = function() {
    ...
    if (e) {
        ...
        if (e)
            return "Gecko" == e[0] ? goog.labs.userAgent.engine.getVersionForKey_(o, "Firefox") : e[1];
        o = o[0];
        if (o && (t = o[2])) {
...
goog.labs.userAgent.platform.getVersion = function() {
    var e, o = goog.labs.userAgent.util.getUserAgent(), t = "";
    return goog.labs.userAgent.platform.isWindows() ? t = (e = /Windows (?:NT|Phone) ([0-9.]+)/.exec(o)) ? e[1] : "0.0" : goog.labs.userAgent.platform.isIos() ? t = (e = /(?:iPhone|iPod|iPad|CPU)\s+OS\s+(\S+)/.exec(o)) && e[1].replace(/_/g, ".") : goog.labs.userAgent.platform.isMacintosh() ? t = (e = /Mac OS X ([0-9_.]+)/.exec(o)) ? e[1].replace(/_/g, ".") : "10" : goog.labs.userAgent.platform.isAndroid() ? t = (e = /Android\s+([^\);]+)(\)|;)/.exec(o)) && e[1] : goog.labs.userAgent.platform.isChromeOS() && (t = (e = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/.exec(o)) && e[1]),
    t || ""
}
,
...
goog.html.SafeStyle.create = function(e) {
    ...
    return t ? (goog.html.SafeStyle.checkStyle_(t),
    goog.html.SafeStyle.createSafeStyleSecurityPrivateDoNotAccessOrElse(t)) : goog.html.SafeStyle.EMPTY
}
,
...
goog.i18n.bidi.guardBracketInText = function(e, o) {
    o = (void 0 === o ? goog.i18n.bidi.hasAnyRtl(e) : o) ? goog.i18n.bidi.Format.RLM : goog.i18n.bidi.Format.LRM;
...
goog.i18n.bidi.estimateDirection = function(e, o) {
    for (var t = 0, r = 0, g = !1, n = goog.i18n.bidi.stripHtmlIfNeeded_(e, o).split(goog.i18n.bidi.wordSeparatorRe_), i = 0; i < n.length; i++) {
        var s = n[i];
        goog.i18n.bidi.startsWithRtl(s) ? (t++,
        r++) : goog.i18n.bidi.isRequiredLtrRe_.test(s) ? g = !0 : goog.i18n.bidi.hasAnyLtr(s) ? r++ : goog.i18n.bidi.hasNumeralsRe_.test(s) && (g = !0)
    }
...
goog.html.SafeUrl.fromBlob = function(e) {
    e = goog.html.SAFE_BLOB_TYPE_PATTERN_.test(e.type) ? goog.fs.url.createObjectUrl(e) : goog.html.SafeUrl.INNOCUOUS_STRING;
...
goog.html.SafeHtml.htmlEscape = function(e) {
    if (e instanceof goog.html.SafeHtml)
        return e;
    var o = null;
    return e.implementsGoogI18nBidiDirectionalString && (o = e.getDirection()),
    e = e.implementsGoogStringTypedString ? e.getTypedStringValue() : String(e),
    goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(goog.string.htmlEscape(e), o)
}
,
...
goog.html.SafeHtml.createIframe = function(e, o, t, r) {
    ...
    g.src = e || null,
    g.srcdoc = o || null;
    t = goog.html.SafeHtml.combineAttributes(g, {
        sandbox: ""
    }, t);
    return goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse("iframe", t, r)
}
,
goog.html.SafeHtml.createStyle = function(e, o) {
    ...
    o = goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(r, goog.i18n.bidi.Dir.NEUTRAL);
    return goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse("style", t, o)
}
,
...
goog.html.SafeHtml.concat = function(e) {
    function o(e) {
        goog.isArray(e) ? goog.array.forEach(e, o) : (e = goog.html.SafeHtml.htmlEscape(e),
...
goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse = function(e, o, t) {
    ...
    g += ">") : (s = goog.html.SafeHtml.concat(t),
    g += ">" + goog.html.SafeHtml.unwrap(s) + "</" + e + ">",
    r = s.getDirection());
    var s = o && o.dir;
    return s && (r = /^(ltr|rtl|auto)$/i.test(s) ? goog.i18n.bidi.Dir.NEUTRAL : null),
...
goog.dom.safe.openInWindow = function(e, o, t, r, g) {
    ...
    return (o || window).open(goog.html.SafeUrl.unwrap(e), t ? goog.string.Const.unwrap(t) : "", r, g)
}
,
...
goog.math.longestCommonSubsequence = function(t, e, o, r) {
    ...
    , i = t.length, s = e.length, a = [], l = 0; l < i + 1; l++)
        a[l] = [],
        a[l][0] = 0;
    for (var u = 0; u < s + 1; u++)
        a[0][u] = 0;
    for (l = 1; l <= i; l++)
        for (u = 1; u <= s; u++)
            g(t[l - 1], e[u - 1]) ? a[l][u] = a[l - 1][u - 1] + 1 : a[l][u] = Math.max(a[l - 1][u], a[l][u - 1]);
    for (var c = [], l = i, u = s; 0 < l && 0 < u; )
        g(t[l - 1], e[u - 1]) ? (c.unshift(n(l - 1, u - 1)),
        l--,
        u--) : a[l - 1][u] > a[l][u - 1] ? l-- : u--;
    return c
}
,
...
goog.dom.getRequiredElementHelper_ = function(e, o) {
    ...
    return e = goog.asserts.assertElement(e, "No element found with id: " + o)
}
,
...
goog.dom.getElementsByTagNameAndClass_ = function(e, o, t, r) {
    ...
    if (t) {
        for (var l, i = {}, s = 0, a = 0; l = n[a]; a++) {
            var u = l.className;
            "function" == typeof u.split && goog.array.contains(u.split(/\s+/), t) && (i[s++] = l)
        }
        return i.length = s,
        i
    }
...
goog.dom.getDocumentHeight_ = function(e) {
    ...
    if (o) {
        ...
        var n = goog.dom.getViewportSize_(e).height
          , t = goog.dom.isCss1CompatMode_(o) && g.scrollHeight ? g.scrollHeight != n ? g.scrollHeight : g.offsetHeight : (e = g.scrollHeight,
        o = g.offsetHeight,
        g.clientHeight != o && (e = r.scrollHeight,
        o = r.offsetHeight),
        n < e ? o < e ? e : o : e < o ? e : o)
    }
    return t
...
goog.dom.getDocumentScroll_ = function(e) {
    ...
    return goog.userAgent.IE && goog.userAgent.isVersionOrHigher("10") && e.pageYOffset != o.scrollTop ? new goog.math.Coordinate(o.scrollLeft,o.scrollTop) : new goog.math.Coordinate(e.pageXOffset || o.scrollLeft,e.pageYOffset || o.scrollTop)
}
,
...
goog.dom.createDom_ = function(e, o) {
    var t, r, g = o[0], n = o[1];
    !goog.dom.BrowserFeature.CAN_ADD_NAME_OR_TYPE_ATTRIBUTES && n && (n.name || n.type) && (t = ["<", g],
    n.name && t.push(' name="', goog.string.htmlEscape(n.name), '"'),
    n.type && (t.push(' type="', goog.string.htmlEscape(n.type), '"'),
    ...
    g = t.join(""));
    g = e.createElement(g);
    return n && (goog.isString(n) ? g.className = n : goog.isArray(n) ? g.className = n.join(" ") : goog.dom.setProperties(g, n)),
...
goog.dom.getParentElement = function(e) {
    ...
    if (goog.dom.BrowserFeature.CAN_USE_PARENT_ELEMENT_PROPERTY) {
        var t = goog.userAgent.IE && goog.userAgent.isVersionOrHigher("9") && !goog.userAgent.isVersionOrHigher("10");
        if (!(t && goog.global.SVGElement && e instanceof goog.global.SVGElement) && (o = e.parentElement))
            return o
    }
...
goog.dom.compareNodeOrder = function(e, o) {
    ...
    if ("sourceIndex"in e || e.parentNode && "sourceIndex"in e.parentNode) {
        ...
        var g = e.parentNode
          , n = o.parentNode;
        return g == n ? goog.dom.compareSiblingOrder_(e, o) : !t && goog.dom.contains(g, o) ? -1 * goog.dom.compareParentsDescendantNodeIe_(e, o) : !r && goog.dom.contains(n, e) ? goog.dom.compareParentsDescendantNodeIe_(o, e) : (t ? e : g).sourceIndex - (r ? o : n).sourceIndex
    }
...
goog.dom.isFocusable = function(e) {
    var o = goog.dom.nativelySupportsFocus_(e) ? !e.disabled && (!goog.dom.hasSpecifiedTabIndex_(e) || goog.dom.isTabIndexFocusable_(e)) : goog.dom.isFocusableTabIndex(e);
...
goog.dom.getTextContent = function(e) {
    var o = goog.dom.BrowserFeature.CAN_USE_INNER_TEXT && "innerText"in e ? goog.string.canonicalizeNewlines(e.innerText) : (goog.dom.getTextContent_(e, o = [], !0),
    o.join(""));
    return o = (o = o.replace(/ \xAD /g, " ").replace(/\xAD/g, "")).replace(/\u200B/g, ""),
    o = " " != (o = !goog.dom.BrowserFeature.CAN_USE_INNER_TEXT ? o.replace(/ +/g, " ") : o) ? o.replace(/^\s*/, "") : o
}
,
...
goog.async.nextTick.getSetImmediateEmulator_ = function() {
    ...
    if (void 0 === (e = void 0 === e && "undefined" != typeof window && window.postMessage && window.addEventListener && !goog.labs.userAgent.engine.isPresto() ? function() {
        ...
        var t = "callImmediate" + Math.random()
          , r = "file:" == o.location.protocol ? "*" : o.location.protocol + "//" + o.location.host
    ...
    : e) || goog.labs.userAgent.browser.isIE())
    ...
    return o.port1.onmessage = function() {
        var e;
        goog.isDef(t.next) && (e = (t = t.next).cb,
        t.cb = null,
        e())
    }
    ,
...
goog.async.run.initializeRunner_ = function() {
    var e;
    goog.global.Promise && goog.global.Promise.resolve ? (e = goog.global.Promise.resolve(),
    ...
    if (this.state_ == goog.Promise.State_.PENDING) {
        if (this == t)
            ...
            if (goog.Thenable.isImplementedBy(t))
                return this.state_ = goog.Promise.State_.BLOCKED,
...
goog.Promise.prototype.addStackTrace_ = function(e) {
    var o;
    goog.Promise.LONG_STACK_TRACES && goog.isString(e.stack) && (o = e.stack.split("\n", 4)[3],
    e = e.message,
...
goog.Disposable.getUndisposedObjects = function() {
    ...
    for (e in goog.Disposable.instances_)
        goog.Disposable.instances_.hasOwnProperty(e) && o.push(goog.Disposable.instances_[Number(e)]);
    return o
}
,
...
goog.events.BrowserEvent.prototype.init = function(e, o) {
    ...
    o = e.relatedTarget;
    o ? goog.userAgent.GECKO && (goog.reflect.canAccessProperty(o, "nodeName") || (o = null)) : t == goog.events.EventType.MOUSEOVER ? o = e.fromElement : t == goog.events.EventType.MOUSEOUT && (o = e.toElement),
...
goog.events.ListenerMap.prototype.getListenerCount = function() {
    ...
    for (e in this.listeners)
        o += this.listeners[e].length;
    return o
}
,
goog.events.ListenerMap.prototype.add = function(e, o, t, r, g) {
    var n, i = e.toString(), s = this.listeners[i];
    s || (s = this.listeners[i] = [],
    this.typeCount_++);
...
goog.events.ListenerMap.prototype.remove = function(e, o, t, r) {
    ...
    0 == e.length && (delete this.listeners[g],
    this.typeCount_--),
    !0)
}
,
...
goog.events.ListenerMap.prototype.getListener = function(e, o, t, r) {
    var g = this.listeners[e.toString()]
      , e = -1;
    return -1 < (e = g ? goog.events.ListenerMap.findListenerIndex_(g, o, t, r) : e) ? g[e] : null
}
,
...
goog.events.listen_ = function(e, o, t, r, g, n) {
    ...
    s || (e[goog.events.LISTENER_MAP_PROP_] = s = new goog.events.ListenerMap(e));
    g = s.add(o, t, r, g, n);
    if (g.proxy)
        return g;
...
goog.events.getProxy = function() {
    var o = goog.events.handleBrowserEvent_
      , t = goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT ? function(e) {
...
goog.events.unlisten = function(e, o, t, r, g) {
    ...
    if (s) {
        ...
        if (i)
            return goog.events.unlistenByKey(i)
    }
    return !1
}
,
goog.events.unlistenByKey = function(e) {
    ...
    var r = o.type
      , e = o.proxy;
    t.removeEventListener ? t.removeEventListener(r, e, o.capture) : t.detachEvent && t.detachEvent(goog.events.getOnString_(r), e),
    goog.events.listenerCountEstimate_--;
    e = goog.events.getListenerMap_(t);
    return e ? (e.removeByKey(o),
...
goog.events.expose = function(e) {
    var o, t = [];
    for (o in e)
        e[o] && e[o].id ? t.push(o + " = " + e[o] + " (" + e[o].id + ")") : t.push(o + " = " + e[o]);
    return t.join("\n")
}
,
...
goog.events.fireListeners_ = function(e, o, t, r) {
    ...
    if (e && (n = e.listeners[o.toString()]))
        for (var n = n.concat(), i = 0; i < n.length; i++) {
            var s = n[i];
            s && s.capture == t && !s.removed && (s = goog.events.fireListener(s, r),
            g = g && !1 !== s)
        }
    return g
}
...
goog.events.handleBrowserEvent_ = function(e, o) {
    ...
    if (goog.events.CAPTURE_SIMULATION_MODE == goog.events.CaptureSimulationMode.ON) {
        if (!goog.events.isMarkedIeEvent_(o)) {
            ...
            for (var g = [], n = t.currentTarget; n; n = n.parentNode)
                g.push(n);
            for (var i = e.type, s = g.length - 1; !t.propagationStopped_ && 0 <= s; s--) {
                t.currentTarget = g[s];
        ...
        r = goog.events.fireListener(e, t);
    return r
}
,
...
goog.events.EventTarget.prototype.fireListeners = function(e, o, t) {
    ...
    for (var r = r.concat(), g = !0, n = 0; n < r.length; ++n) {
        var i, s, a = r[n];
        a && !a.removed && a.capture == o && (i = a.listener,
        s = a.handler || a.src,
...
goog.events.EventTarget.dispatchEventInternal_ = function(e, o, t) {
    var r, g = o.type || o;
    goog.isString(o) ? o = new goog.events.Event(o,e) : o instanceof goog.events.Event ? o.target = o.target || e : (r = o,
    o = new goog.events.Event(g,e),
    goog.object.extend(o, r));
    var n, i = !0;
    if (t)
        for (var s = t.length - 1; !o.propagationStopped_ && 0 <= s; s--)
            i = (n = o.currentTarget = t[s]).fireListeners(g, !0, o) && i;
    if (o.propagationStopped_ || (i = (n = o.currentTarget = e).fireListeners(g, !0, o) && i,
...
goog.Timer.prototype.tick_ = function() {
    var e;
    this.enabled && (0 < (e = goog.now() - this.last_) && e < this.interval_ * goog.Timer.intervalScale ? this.timer_ = this.timerObject_.setTimeout(this.boundTick_, this.interval_ - e) : (this.timer_ && (this.timerObject_.clearTimeout(this.timer_),
    this.timer_ = null),
    this.dispatchTick(),
...
goog.json.Serializer.prototype.serializeObject_ = function(e, o) {
    ...
    var t, r, g = "";
    for (t in e)
        !Object.prototype.hasOwnProperty.call(e, t) || "function" != typeof (r = e[t]) && (o.push(g),
        this.serializeString_(t, o),
        o.push(":"),
        this.serializeInternal(this.replacer_ ? this.replacer_.call(e, t, r) : r, o),
        g = ",");
    o.push("}")
}
,
...
goog.structs.isEmpty = function(e) {
    return "function" == typeof e.isEmpty ? e.isEmpty() : (goog.isArrayLike(e) || goog.isString(e) ? goog.array : goog.object).isEmpty(e)
}
,
goog.structs.clear = function(e) {
    "function" == typeof e.clear ? e.clear() : (goog.isArrayLike(e) ? goog.array : goog.object).clear(e)
}
,
...
goog.structs.filter = function(e, o, t) {
    ...
    if (r)
        ...
        i = [];
        for (s = 0; s < n; s++)
            o.call(t, g[s], void 0, e) && i.push(g[s])
    }
    return i
}
,
goog.structs.map = function(e, o, t) {
    ...
    if (r)
        for (var i = {}, s = 0; s < n; s++)
            i[r[s]] = o.call(t, g[s], r[s], e);
    else {
        i = [];
        for (s = 0; s < n; s++)
            i[s] = o.call(t, g[s], void 0, e)
    }
    return i
}
,
...
goog.iter.zip = function(e) {
    var o, t = arguments, r = new goog.iter.Iterator;
    return 0 < t.length && (o = goog.array.map(t, goog.iter.toIterator),
    r.next = function() {
...
goog.iter.zipLongest = function(r, e) {
    var o, t = goog.array.slice(arguments, 1), g = new goog.iter.Iterator;
    return 0 < t.length && (o = goog.array.map(t, goog.iter.toIterator),
    g.next = function() {
        var t = !1
...
goog.iter.tee = function(e, o) {
    ...
    return goog.array.map(r, function(e) {
        ...
        return o.next = function() {
            var o;
            return goog.array.isEmpty(e) && (o = t.next(),
...
goog.structs.Map.prototype.addAll = function(e) {
    for (var o, t = e instanceof goog.structs.Map ? (o = e.getKeys(),
    e.getValues()) : (o = goog.object.getKeys(e),
    goog.object.getValues(e)), r = 0; r < o.length; r++)
        this.set(o[r], t[r])
}
,
...
goog.debug.catchErrors = function(n, e, o) {
    var o = o || goog.global
      , i = o.onerror
      , s = !!e;
    goog.userAgent.WEBKIT && !goog.userAgent.isVersionOrHigher("535.3") && (s = !s),
...
goog.debug.deepExpose = function(e, i) {
        ...
        try {
            if (goog.isDef(e))
                if (goog.isNull(e))
                    ...
                    if (g.contains(e))
                        a.push("*** reference loop detected ***");
                    else {
                        for (var n in g.add(e),
                        a.push("{"),
                        e)
                            !i && goog.isFunction(e[n]) || (a.push("\n"),
                            a.push(r),
                            a.push(n + " = "),
                            s(e[n], r, g));
                        a.push("\n" + o + "}")
    ...
    var a = [];
    return s(e, "", new goog.structs.Set),
    a.join("")
}
,
...
goog.debug.createViewSourceUrl_ = function(e) {
    ...
    return goog.html.uncheckedconversions.safeUrlFromStringKnownToSatisfyTypeContract(goog.string.Const.from("view-source scheme plus HTTP/HTTPS URL"), "view-source:" + goog.html.SafeUrl.unwrap(e))
}
,
...
goog.debug.getStacktrace = function(e) {
    var o;
    return goog.STRICT_MODE_COMPATIBLE && (o = e || goog.debug.getStacktrace,
    o = goog.debug.getNativeStackTrace_(o)),
    o = o || goog.debug.getStacktraceHelper_(e || arguments.callee.caller, [])
}
,
...
goog.debug.getFunctionName = function(e) {
    ...
    o = String(e);
    return goog.debug.fnNameCache_[o] || ((e = /function ([^\(]+)/.exec(o)) ? (e = e[1],
    goog.debug.fnNameCache_[o] = e) : goog.debug.fnNameCache_[o] = "[Anonymous]"),
...
goog.debug.Logger.prototype.getEffectiveLevel = function() {
    return goog.debug.LOGGING_ENABLED ? goog.debug.Logger.ENABLE_HIERARCHY ? this.level_ || (this.parent_ ? this.parent_.getEffectiveLevel() : (goog.asserts.fail("Root logger has no level set."),
...
goog.debug.Logger.prototype.getLogRecord = function(e, o, t) {
    o = goog.debug.LogBuffer.isBufferingEnabled() ? goog.debug.LogBuffer.getInstance().addRecord(e, o, this.name_) : new goog.debug.LogRecord(e,String(o),this.name_);
    return t && o.setException(t),
    o
}
,
...
goog.debug.LogManager.createLogger_ = function(e) {
    var o, t, r = new goog.debug.Logger(e);
    return goog.debug.Logger.ENABLE_HIERARCHY && (o = e.lastIndexOf("."),
    t = e.substr(0, o),
    o = e.substr(o + 1),
...
goog.uri.utils.getEffectiveScheme = function(e) {
    ...
    return (o = !o && self.location ? (e = self.location.protocol).substr(0, e.length - 1) : o) ? o.toLowerCase() : ""
}
,
...
goog.uri.utils.getHost = function(e) {
    ...
    return goog.uri.utils.buildFromEncodedParts(e[goog.uri.utils.ComponentIndex.SCHEME], e[goog.uri.utils.ComponentIndex.USER_INFO], e[goog.uri.utils.ComponentIndex.DOMAIN], e[goog.uri.utils.ComponentIndex.PORT])
}
,
goog.uri.utils.getPathAndAfter = function(e) {
    e = goog.uri.utils.split(e);
    return goog.uri.utils.buildFromEncodedParts(null, null, null, null, e[goog.uri.utils.ComponentIndex.PATH], e[goog.uri.utils.ComponentIndex.QUERY_DATA], e[goog.uri.utils.ComponentIndex.FRAGMENT])
}
,
...
goog.uri.utils.haveSameDomain = function(e, o) {
    e = goog.uri.utils.split(e),
    o = goog.uri.utils.split(o);
    return e[goog.uri.utils.ComponentIndex.DOMAIN] == o[goog.uri.utils.ComponentIndex.DOMAIN] && e[goog.uri.utils.ComponentIndex.SCHEME] == o[goog.uri.utils.ComponentIndex.SCHEME] && e[goog.uri.utils.ComponentIndex.PORT] == o[goog.uri.utils.ComponentIndex.PORT]
}
,
...
goog.uri.utils.appendQueryData_ = function(e) {
    var o, t;
    return e[1] && (0 <= (t = (o = e[0]).indexOf("#")) && (e.push(o.substr(t)),
    e[0] = o = o.substr(0, t)),
    (t = o.indexOf("?")) < 0 ? e[1] = "?" : t == o.length - 1 && (e[1] = void 0)),
    e.join("")
}
,
...
goog.uri.utils.appendParam = function(e, o, t) {
    o = [e, "&", o];
    return goog.isDefAndNotNull(t) && o.push("=", goog.string.urlEncode(t)),
...
goog.uri.utils.findParam_ = function(e, o, t, r) {
    for (var g = o, n = t.length; 0 <= (g = e.indexOf(t, g)) && g < r; ) {
        ...
        if (i == goog.uri.utils.CharCode_.AMPERSAND || i == goog.uri.utils.CharCode_.QUESTION) {
            i = e.charCodeAt(g + n);
            if (!i || i == goog.uri.utils.CharCode_.EQUAL || i == goog.uri.utils.CharCode_.AMPERSAND || i == goog.uri.utils.CharCode_.HASH)
                return g
        }
        g += n + 1
    }
...
goog.uri.utils.setPath = function(e, o) {
    ...
    e = goog.uri.utils.split(e);
    return goog.uri.utils.buildFromEncodedParts(e[goog.uri.utils.ComponentIndex.SCHEME], e[goog.uri.utils.ComponentIndex.USER_INFO], e[goog.uri.utils.ComponentIndex.DOMAIN], e[goog.uri.utils.ComponentIndex.PORT], o, e[goog.uri.utils.ComponentIndex.QUERY_DATA], e[goog.uri.utils.ComponentIndex.FRAGMENT])
}
,
...
goog.net.XhrIo.send = function(e, o, t, r, g, n, i) {
    ...
    return goog.net.XhrIo.sendInstances_.push(s),
...
goog.net.XhrIo.prototype.send = function(e, o, t, r) {
    ...
    this.xhrOptions_ = (this.xmlHttpFactory_ || goog.net.XmlHttp).getOptions(),
    ...
    !goog.array.contains(goog.net.XhrIo.METHODS_WITH_FORM_DATA, o) || t || r || g.set(goog.net.XhrIo.CONTENT_TYPE_HEADER, goog.net.XhrIo.FORM_CONTENT_TYPE),
...
goog.net.XhrIo.prototype.onReadyStateChangeHelper_ = function() {
    if (this.active_ && void 0 !== goog)
        ...
        else if (this.inSend_ && this.getReadyState() == goog.net.XmlHttp.ReadyState.COMPLETE)
...
goog.net.XhrIo.prototype.getResponseHeaders = function() {
    for (var e, o = {}, t = this.getAllResponseHeaders().split("\r\n"), r = 0; r < t.length; r++)
        goog.string.isEmptyOrWhitespace(t[r]) || (o[(e = goog.string.splitLimit(t[r], ": ", 2))[0]] ? o[e[0]] += ", " + e[1] : o[e[0]] = e[1]);
    return o
}
,
...
goog.Uri.prototype.toString = function() {
    ...
    o = this.getDomain();
    o && (e.push("//"),
    (t = this.getUserInfo()) && e.push(goog.Uri.encodeSpecialChars_(t, goog.Uri.reDisallowedInSchemeOrUserInfo_, !0), "@"),
    e.push(goog.Uri.removeDoubleEncoding_(goog.string.urlEncode(o))),
    null != (t = this.getPort()) && e.push(":", String(t)));
    var t = this.getPath();
    t && (this.hasDomain() && "/" != t.charAt(0) && e.push("/"),
    e.push(goog.Uri.encodeSpecialChars_(t, "/" == t.charAt(0) ? goog.Uri.reDisallowedInAbsolutePath_ : goog.Uri.reDisallowedInRelativePath_, !0)));
    t = this.getEncodedQuery();
    t && e.push("?", t);
    t = this.getFragment();
    return t && e.push("#", goog.Uri.encodeSpecialChars_(t, goog.Uri.reDisallowedInFragment_)),
    e.join("")
}
,
goog.Uri.prototype.resolve = function(e) {
    ...
    var r, g = e.getPath();
    return t ? o.setPort(e.getPort()) : (t = e.hasPath()) && ("/" != g.charAt(0) && (this.hasDomain() && !this.hasPath() ? g = "/" + g : -1 != (r = o.getPath().lastIndexOf("/")) && (g = o.getPath().substr(0, r + 1) + g)),
...
goog.Uri.haveSameDomain = function(e, o) {
    e = goog.uri.utils.split(e),
    o = goog.uri.utils.split(o);
    return e[goog.uri.utils.ComponentIndex.DOMAIN] == o[goog.uri.utils.ComponentIndex.DOMAIN] && e[goog.uri.utils.ComponentIndex.PORT] == o[goog.uri.utils.ComponentIndex.PORT]
}
,
...
goog.Uri.QueryData.prototype.ensureKeyMapInitialized_ = function() {
    var t;
    this.keyMap_ || (this.keyMap_ = new goog.structs.Map,
    this.count_ = 0,
    this.encodedQuery_ && goog.uri.utils.parseQueryData((t = this).encodedQuery_, function(e, o) {
...
goog.Uri.QueryData.prototype.get = function(e, o) {
    ...
    return goog.Uri.preserveParameterTypesCompatibilityFlag ? 0 < e.length ? e[0] : o : 0 < e.length ? String(e[0]) : o
}
,
...
goog.Uri.QueryData.prototype.toString = function() {
    ...
    for (var e = [], o = this.keyMap_.getKeys(), t = 0; t < o.length; t++)
        for (var r = o[t], g = goog.string.urlEncode(r), n = this.getValues(r), i = 0; i < n.length; i++) {
            var s = g;
            "" !== n[i] && (s += "=" + goog.string.urlEncode(n[i])),
            e.push(s)
        }
...
goog.Uri.QueryData.prototype.extend = function(e) {
    for (var o = 0; o < arguments.length; o++)
        goog.structs.forEach(arguments[o], function(e, o) {
            this.add(o, e)
        }, this)
}
;
...
function asyncFindWebService(o, e) {
    ...
    r ? goog.net.XhrIo.send(WS_PROTOCOL + t + ":" + r + "/" + WS_SVC_PATH + "/" + WS_CMD_STATUS, function(e) {
        e.target.isSuccess() ? o() : (setCachedService(null, null),
        _findWebService(WS_SVC_HOST, o, g))
    }, "GET", void 0, void 0, WS_CHECK_TIMEOUT) : _findWebService(WS_SVC_HOST, o, g)
}
function syncCheckWebService(t, e) {
    ...
    checkServiceStatus(n, o) ? g(n, o) : r && checkServiceStatus(n, WS_SVC_HOST_LEGACY) ? g(n, WS_SVC_HOST_LEGACY) : (setCachedService(null, null),
    e())
}
...
function invokeWsCommandAsync(n, i, s) {
    ...
    return new goog.Promise(function(r, g) {
        var e, o = [], t = null;
        for (e in s)
            o.push(encodeURIComponent(e) + "=" + encodeURIComponent(s[e]));
        "POST" == n ? t = o.length ? o.join("&") : "" : a += o.length ? "?" + o.join("&") : "",
        goog.net.XhrIo.send(a, function(o) {
            var e = o.target
              , t = null;
            if (e.isSuccess()) {
                o = e.getResponse();
                ...
                e = "Failed to execute webservice command: " + i + ". Error: " + e.getStatus();
                traceMsg("invokeWsCommandAsync > " + e),
                g(new Error(e))
            }
        }, n || "GET", t, void 0, WS_COMMAND_TIMEOUT)
    }
    )
}
...
function DlsWebService() {
    ...
    this.getConsumableInfoIn550PrinterAsync = function(e) {
        return invokeWsCommandAsync("GET", WS_CMD_GET_CONSUMABLE_INFO_IN_550_PRINTER, {
            printerName: e
        })
    }
}
...
goog.dom.xml.selectNodes = function(e, o) {
    if (void 0 !== e.selectNodes)
        ...
        e.selectNodes(o);
    if (document.implementation.hasFeature("XPath", "3.0")) {
        for (var t, r = (t = goog.dom.getOwnerDocument(e)).createNSResolver(t.documentElement), g = t.evaluate(o, e, r, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null), n = [], i = g.snapshotLength, s = 0; s < i; s++)
...
dymo.xml.serialize = function(e) {
    return goog.dom.xml.serialize(e).replaceAll(/<Color (.+)\/>/g, "<Color $1> </Color>")
}
,
...
dymo.label.framework.LabelSetBuilder.toXml = function(e) {
    for (var o = dymo.xml.parse("<LabelSet/>"), t = o.documentElement, r = 0; r < e.length; r++) {
        var g, n = e[r], i = o.createElement("LabelRecord");
        for (g in n) {
            var s, a, l = n[g];
            "function" != typeof l && (l = l.toString(),
            (s = o.createElement("ObjectData")).setAttribute("Name", g),
            0 == l.indexOf(TextMarkupTag) ? (a = dymo.xml.parse(l),
            s.appendChild(a.documentElement.cloneNode(!0))) : (l = o.createTextNode(l),
            s.appendChild(l)),
            i.appendChild(s))
        }
        t.appendChild(i)
...
dymo.label.framework.Label.prototype.isDLSLabel = function() {
    var e = !1
      , o = this.getLabelXml();
    return e = o ? -1 !== o.indexOf("</DieCutLabel>") || -1 !== o.indexOf("</ContinuousLabel>") : e
}
,
...
dymo.label.framework.Label.prototype._getAddressObjectText = function(e) {
    ...
    if (this.isDCDLabel())
        for (var t = dymo.xml.getElement(e, "FormattedText"), r = dymo.xml.getElements(t, "LineTextSpan"), g = 0; g < r.length; g++)
            for (var n = dymo.xml.getElements(r[g], "TextSpan"), i = 0; i < n.length; i++) {
        ...
        o = goog.array.reduce(e, function(e, o) {
...
dymo.label.framework.Label.prototype._getQRcodeObjectText = function(e) {
    var o = "";
    return !this.isDCDLabel() || (e = dymo.xml.getElement(e, "Data")) && (e = dymo.xml.getElement(e, "DataString"),
...
dymo.label.framework.Label.prototype._getDateTimeCounterObjectText = function(e) {
    var o, t = "";
    return this.isDCDLabel() ? (o = dymo.xml.getElement(e, "FormattedText"),
    (o = dymo.xml.getElements(o, "LineTextSpan")) && (o = dymo.xml.getElements(o[0], "TextSpan"),
    o = dymo.xml.getElement(o[0], "Text"),
    t += dymo.xml.getElementText(o))) : t = dymo.xml.getElementText(dymo.xml.getElement(e, "PreText")),
    t
}
,
...
dymo.label.framework.Label.prototype._setAddressObjectText = function(e, o) {
    var t, r, g, n;
    return this.isDCDLabel() ? (t = dymo.xml.getElement(e, "FormattedText"),
    !(t = dymo.xml.getElements(t, "LineTextSpan")) || (n = dymo.xml.getElements(t[0], "TextSpan")) && (g = dymo.xml.getElement(n[0], "Text"),
    dymo.xml.setElementText(g, o))) : (t = dymo.xml.getElement(e, "StyledText"),
    n = this._getStyledTextLineAttributes(t),
    g = [],
    0 == (g = (e = dymo.xml.getElement(e, "LineFonts")) ? dymo.xml.getElements(e, "Font") : g).length && (r = dymo.xml.parse('<Font Family="Arial" Size="12" Bold="False" Italic="False" Underline="False" Strikeout="False" />').documentElement),
    e = dymo.xml.parse('<ForeColor Alpha="255" Red="0" Green="0" Blue="0" />').documentElement,
    dymo.xml.removeAllChildren(t),
    r = r,
    0 < g.length ? r = g[g.length - 1] : 0 < n.length && (r = dymo.xml.getElement(n[n.length - 1], "Font")),
    g = e,
    ...
    (o = t.ownerDocument.createElement("Attributes")).appendChild(r.cloneNode(!0)),
...
dymo.label.framework.Label.prototype._setBarcodeObjectText = function(e, o) {
    var t = this.isDCDLabel() ? "Data" : "Text"
      , t = dymo.xml.getElement(e, t);
    return t && dymo.xml.setElementText(t, o),
    this
}
,
...
dymo.label.framework.Label.prototype._setDateTimeCounterObjectText = function(e, o) {
    var t;
    return this.isDCDLabel() ? (t = dymo.xml.getElement(e, "FormattedText"),
    (t = dymo.xml.getElements(t, "LineTextSpan")) && (t = dymo.xml.getElements(t[0], "TextSpan"),
    t = dymo.xml.getElement(t[0], "Text"),
    dymo.xml.setElementText(t, o))) : dymo.xml.setElementText(dymo.xml.getElement(e, "PreText"), o),
    this
}
,
...
dymo.label.framework.Label.prototype.setLabelLength = function(e) {
    ...
    return dymo.xml.setElementText(dymo.xml.getElement(o, "Length"), e),
    dymo.xml.setElementText(dymo.xml.getElement(o, "LengthMode"), t),
    this
}
,
...
goog.async.Deferred = function(e, o) {
    ...
    "string" == typeof o.stack && (this.constructorStack_ = o.stack.replace(/^[^\n]*\n/, ""))))
}
,
...
goog.async.Deferred.prototype.cancel = function(e) {
    var o;
    this.hasFired() ? this.result_ instanceof goog.async.Deferred && this.result_.cancel() : (this.parent_ && (o = this.parent_,
    delete this.parent_,
...
goog.async.Deferred.prototype.fire_ = function() {
    ...
    delete this.parent_);
    for (var e, o, t = this.result_, r = !1, g = !1; this.sequence_.length && !this.blocked_; ) {
        ...
        if (i)
            try {
                ...
                goog.isDef(a) && (this.hadError_ = this.hadError_ && (a == t || this.isError(a)),
                this.result_ = t = a),
                (goog.Thenable.isImplementedBy(t) || "function" == typeof goog.global.Promise && t instanceof goog.global.Promise) && (g = !0,
                this.blocked_ = !0)
            } catch (e) {
                t = e,
                this.hadError_ = !0,
    ...
    this.result_ = t,
    g ? (e = goog.bind(this.continue_, this, !0),
    o = goog.bind(this.continue_, this, !1),
    t instanceof goog.async.Deferred ? (t.addCallbacks(e, o),
    t.blocking_ = !0) : t.then(e, o)) : !goog.async.Deferred.STRICT_ERRORS || !this.isError(t) || t instanceof goog.async.Deferred.CanceledError || (r = this.hadError_ = !0),
...
goog.async.Deferred.when = function(e, o, t) {
    return (e instanceof goog.async.Deferred ? e.branch(!0) : goog.async.Deferred.succeed(e)).addCallback(o, t)
}
,
...
goog.async.Deferred.assertNoErrors = function() {
    var e, o = goog.async.Deferred.errorMap_;
    for (e in o) {
        var t = o[e];
        t.resetTimer(),
        t.throwError()
...
goog.net.jsloader.loadMany = function(o, t) {
    var e, r;
    o.length && (e = goog.net.jsloader.scriptsToLoad_.length,
    goog.array.extend(goog.net.jsloader.scriptsToLoad_, o),
    e || (o = goog.net.jsloader.scriptsToLoad_,
    (r = function() {
        var e = o.shift()
...
goog.net.jsloader.load = function(e, o) {
    var t = o || {}
      ...
      , s = null
      , o = goog.isDefAndNotNull(t.timeout) ? t.timeout : goog.net.jsloader.DEFAULT_TIMEOUT;
    return 0 < o && (s = window.setTimeout(function() {
    ...
    g.onload = g.onreadystatechange = function() {
        var e;
        g.readyState && "loaded" != g.readyState && "complete" != g.readyState || (e = t.cleanupWhenDone || !1,
...
goog.net.jsloader.loadAndVerify = function(o, t, e) {
    ...
    return e.addCallback(function() {
        var e = r[t];
        goog.isDef(e) ? (g.callback(e),
        delete r[t]) : g.errback(new goog.net.jsloader.Error(goog.net.jsloader.ErrorCode.VERIFY_ERROR,"Script " + o + " loaded, but verification object " + t + " was not defined."))
    }),
...
goog.net.jsloader.cancel_ = function() {
    var e;
    this && this.script_ && ((e = this.script_) && e.tagName == goog.dom.TagName.SCRIPT && goog.net.jsloader.cleanup_(e, !0, this.timeout_))
}
,
...
goog.net.IframeIo.handleIncrementalData = function(e, o) {
    var t = (goog.string.endsWith(e.name, goog.net.IframeIo.INNER_FRAME_SUFFIX) ? e.parent : e).name
      , e = t.substring(0, t.lastIndexOf("_"))
      , e = goog.net.IframeIo.getInstanceByName(e);
    e && t == e.iframeName_ ? e.handleIncrementalData_(o) : (o = goog.log.getLogger("goog.net.IframeIo"),
...
goog.net.IframeIo.getForm_ = function() {
    var e;
    return goog.net.IframeIo.form_ || (goog.net.IframeIo.form_ = goog.dom.createDom(goog.dom.TagName.FORM),
...
goog.net.IframeIo.prototype.send = function(e, o, t, r) {
    ...
    o = o ? o.toUpperCase() : "GET";
    t && e.makeUnique(),
    goog.log.info(this.logger_, "Sending iframe request: " + e + " [" + o + "]"),
    this.form_ = goog.net.IframeIo.getForm_(),
    "GET" == o && goog.net.IframeIo.addFormInputs_(this.form_, e.getQueryData()),
...
goog.net.IframeIo.prototype.abort = function(e) {
    var o;
    this.active_ && (goog.log.info(this.logger_, "Request aborted"),
...
goog.net.IframeIo.prototype.sendFormInternal_ = function() {
    ...
    goog.net.IframeIo.useIeReadyStateCodePath_()) {
        ...
        s.target = o,
        s.action = this.form_.action,
        t.body.appendChild(s);
        for (var a = this.form_.getElementsByTagName(goog.dom.TagName.SELECT), l = s.getElementsByTagName(goog.dom.TagName.SELECT), g = 0, n = a.length; g < n; g++)
            for (var u = a[g].getElementsByTagName(goog.dom.TagName.OPTION), c = l[g].getElementsByTagName(goog.dom.TagName.OPTION), d = 0, m = u.length; d < m; d++)
                c[d].selected = u[d].selected;
        for (var p = this.form_.getElementsByTagName(goog.dom.TagName.INPUT), f = s.getElementsByTagName(goog.dom.TagName.INPUT), g = 0, n = p.length; g < n; g++)
...
goog.net.IframeIo.createIframeHtml_ = function(e) {
    ...
    return goog.html.uncheckedconversions.safeHtmlFromStringKnownToSatisfyTypeContract(goog.string.Const.from("Short HTML snippet, input escaped, for performance"), '<body><iframe id="' + e + '" name="' + e + '"></iframe>')
}
,
goog.net.IframeIo.createIframeHtmlWithBaseUri_ = function(e) {
    e = goog.string.htmlEscape(e);
    return goog.html.uncheckedconversions.safeHtmlFromStringKnownToSatisfyTypeContract(goog.string.Const.from("Short HTML snippet, input escaped, safe URL, for performance"), '<head><base href="' + goog.string.htmlEscape(document.baseURI) + '"></head><body><iframe id="' + e + '" name="' + e + '"></iframe>')
}
,
...
goog.net.IframeIo.prototype.createIframe_ = function() {
    ...
    e.width = e.height = "10px",
    e.display = "none",
    goog.userAgent.WEBKIT ? e.marginTop = e.marginLeft = "-10px" : (e.position = "absolute",
    e.top = e.left = "-10px")
}
,
...
dymo.uuid.uuid = function() {
    for (var n = Array, i = new n(16), o = [], r = {}, e = 0; e < 256; e++)
        o[e] = (e + 256).toString(16).substr(1).toUpperCase(),
        r[o[e]] = e;
    function s(e) {
...
dymo.label.framework.NetworkPrinterName.splitNetworkPrinterName = function(e) {
    var o = new goog.Uri(e)
      , e = o.getPath();
    return 1 < e.length && "/" == e.charAt(0) && (e = e.slice(1)),
    o.setPath(""),
...
function _createSafariPlugin() {
    if (ASSUME_MOBILE)
        return null;
    var e, o = "_DymoLabelFrameworkJslSafariPlugin";
    return document.getElementById(o) || ((e = document.createElement("embed")).type = "application/x-dymolabel",
    e.id = o,
    e.width = 1,
    e.height = 1,
    e.hidden = !0,
...
function _createNsapiPlugin2(e) {
    if (ASSUME_MOBILE)
        return null;
    var o, t = "_DymoLabelFrameworkJslPlugin";
    return document.getElementById(t) || ((o = document.createElement("embed")).type = "application/x-dymolabel",
    o.id = t,
    e ? (o.width = 1,
    o.height = 1,
    o.hidden = !0) : (o.width = 0,
    o.height = 0,
    o.hidden = !1),
...
function _createMacNsapiPlugin2(e) {
    if (ASSUME_MOBILE)
        return null;
    var o, t = "_DymoLabelFrameworkJslPlugin";
    return document.getElementById(t) || ((o = document.createElement("embed")).type = "application/x-npapi-dymolabel",
    o.id = t,
    e ? (o.width = 1,
    o.height = 1,
    o.hidden = !0) : (o.width = 0,
...
dymo.label.framework.PrintJobStatusInfo.parse = function(e) {
    var o = {}
      , e = e.split(" ");
    return 1 <= e.length && (o.status = parseInt(e[0], 10)),
...
dymo.label.framework.chooseEnvironment = function(e) {
    ...
    if (e.isWebServicePresent) {
        ...
        return o = {
            ...
            getJobStatus: function(e, o) {
                var t = goog.isFunction(n.getJobStatus) ? dymo.label.framework.PrintJobStatusInfo.parse(n.getJobStatus(e, parseInt(o, 10))) : {
                    status: dymo.label.framework.PrintJobStatus.Unknown,
                    statusMessage: "not implemented"
                };
                return new dymo.label.framework.PrintJobStatusInfo(e,o,t.status,t.statusMessage)
            },
    ...
    if ("ActiveXObject"in window) {
        ...
        o.getJobStatus = function(e, o) {
            var t = goog.isFunction(i.GetJobStatus) ? dymo.label.framework.PrintJobStatusInfo.parse(i.GetJobStatus(e, parseInt(o, 10))) : {
                status: dymo.label.framework.PrintJobStatus.Unknown,
                statusMessage: "not implemented"
            };
            return new dymo.label.framework.PrintJobStatusInfo(e,o,t.status,t.statusMessage)
        ...
        o = {
            ...
            getJobStatus: function(e, o) {
                var t = goog.isFunction(s.getJobStatus) ? dymo.label.framework.PrintJobStatusInfo.parse(s.getJobStatus(e, parseInt(o, 10))) : {
                    status: dymo.label.framework.PrintJobStatus.Unknown,
                    statusMessage: "not implemented"
                };
                return new dymo.label.framework.PrintJobStatusInfo(e,o,t.status,t.statusMessage)
        ...
        g = _findPlugin("application/x-dymolabel") ? (traceMsg("chooseEnvironment > _createSafariPlugin"),
        ...
        o = {
            ...
            getJobStatus: function(e, o) {
                var t = goog.isFunction(g.getJobStatus) ? dymo.label.framework.PrintJobStatusInfo.parse(g.getJobStatus(e, parseInt(o, 10))) : {
                    status: dymo.label.framework.PrintJobStatus.Unknown,
                    statusMessage: "not implemented"
                };
                return new dymo.label.framework.PrintJobStatusInfo(e,o,t.status,t.statusMessage)
    ...
    ;
    return o.getPrintersAsync = e(o.getPrinters),
    ...
    o.getConsumableInfoIn550PrinterAsync = e(o.getConsumableInfoIn550Printer),
    o
}
,
...
var createFaultyFramework = function(e) {
    var o = e || new Error("DYMO Label Framework Plugin or WebService are not installed")
      , e = function() {
        throw o
    };
    return {
...
function e(o, t) {
    ...
    if (i1a)
        return traceMsg("_createFramework > returning existing instance of _framework, has callBack: " + !!o),
        o && o(k1a),
        i1a;
    if (this && this.constructor == e)
        ...
        dymo.label.framework.checkEnvironment(function(e) {
            traceMsg("onEnvironmentChecked > checkResult isBrowserSupported : " + (k1a = e).isBrowserSupported + ", isFrameworkInstalled: " + e.isFrameworkInstalled + ", isWebServicePresent: " + e.isWebServicePresent + ", errorDetails: " + e.errorDetails);
            try {
        ...
        traceMsg("_createFramework > return _framework : " + i1a + (t ? " (async)" : " (sync)")),
        i1a;
    return new e(o,t)
}
), i1a, j1a, k1a;
...
dymo.label.framework.PrintJob.prototype.getStatusForNetworkPrinter = function(o) {
    var t = this.getPrinterName()
      , r = this._jobId
      , g = this._printerInfo.printerUri;
    new goog.net.Jsonp(goog.Uri.resolve(g, "getPrintJobStatus"),"callback").send({
        jobId: r,
        printerName: this._printerInfo.originalPrinterName
    }, function(e) {
        e = new dymo.label.framework.PrintJobStatusInfo(t,r,e.status,e.statusMessage);
        o(e)
    }, function() {
        var e = new dymo.label.framework.PrintJobStatusInfo(t,r,dymo.label.framework.PrintJobStatus.ProcessingError,'Error processing getPrintJobStatus(): Unable to contact "' + g + '"');
        o(e)
    })
}
,
...
dymo.label.framework.checkEnvironment = function(e, o) {
    ...
    function r() {
        !function() {
            ...
            var e, o = window.navigator.platform;
            if (-1 != o.indexOf("Win"))
                ...
                -1 != o.indexOf("Mac") ? (traceMsg("checkLegacyPlugins > Mac platform"),
                g.isBrowserSupported = !0,
                _findPlugin("application/x-dymolabel") ? (traceMsg("checkLegacyPlugins > safariPluginFound"),
                "2.0" <= (e = _createSafariPlugin()).GetAPIVersion() ? g.isFrameworkInstalled = !0 : g.errorDetails = "DYMO Label Safari Plugin is installed but outdated. Install the latest version.") : _findPlugin("application/x-npapi-dymolabel") ? (traceMsg("checkLegacyPlugins > 'application/x-npapi-dymolabel'"),
                (e = _createMacNsapiPlugin()) && e.getPrinters ? g.isFrameworkInstalled = !0 : g.errorDetails = 'DYMO NSAPI plugin is loaded but no callable functions found. If running Safari, then run it in 64-bit mode (MacOS X >= 10.7) or set "Open using Rosetta" option') : g.errorDetails = "DYMO Label Plugin is not installed.") : g.errorDetails = "The operating system is not supported."
        }(),
        e && e(g)
    }
    var g = {
    ...
    g.isFrameworkInstalled = !0,
    g.isWebServicePresent = !1,
    e && e(g))) : (o ? asyncFindWebService : syncCheckWebService)(t, r),
    g
}
;
...
function getPrinters(e) {
    ...
    for (var e = dymo.xml.parse(e), t = createPrintersCollection(), e = dymo.xml.getElement(e, "Printers"), r = dymo.xml.getElements(e, "LabelWriterPrinter"), g = 0; g < r.length; g++) {
        var n = o(r[g], "Name")
          , i = o(r[g], "ModelName")
          , s = "True" == o(r[g], "IsConnected")
          , a = "True" == o(r[g], "IsLocal")
          , l = "True" == o(r[g], "IsTwinTurbo");
        addPrinterToCollection(new dymo.label.framework.LabelWriterPrinterInfo(n,i,s,a,l), t)
    }
    ...
    for (g = 0; g < u.length; g++) {
        ...
        addPrinterToCollection(new dymo.label.framework.TapePrinterInfo(n,i,s,a,c), t)
    }
    ...
    for (g = 0; g < d.length; g++)
        ...
        addPrinterToCollection(new dymo.label.framework.DZPrinterInfo(n,i,s,a,c), t);
    return t
}
...
function getPrintersByType(e) {
    for (var o = [], t = (t = dymo.label.framework.getPrinters()).byIndex, r = 0; r < t.length; r++) {
        var g = t[r];
...
function printLabelToNetworkPrinter(e, o, t, r) {
    function n(r, g) {
        ...
        new goog.net.Jsonp(s,"c").send({
            ...
            0 == o ? -1 != r ? n(++r, 0) : t.info("Finished sending job payload for " + i) : -5 == o ? g < 10 ? n(++e.lastAckChunkId, ++g) : t.warning('Unable to send print job data for "' + i + '": STATUS_INVALID_CHUNK_ID: Max retry count reached') : g < 10 ? n(r, ++g) : t.warning('Unable to send print job data for "' + i + '": Max retry count reached')
        }, function() {
            var e = new goog.debug.Logger("dymo.label.framework");
            e.setLevel(goog.debug.Logger.Level.INFO),
            g < 10 ? n(r, ++g) : e.warning('Unable to send print job data for "' + i + '": error: Max retry count reached')
        })
    }
    ...
    return n(0, 0),
    new dymo.label.framework.PrintJob(e,i)
}
...
dymo.label.framework.addPrinterUri = function(o, e, t, r) {
    ...
    new goog.net.Jsonp(e,"callback").send(null, function(e) {
        e = new NetworkPrinterInfo(o,g,e);
        _networkPrinters[o] = e,
        t && t(o)
    }, n)
}
,
...
dymo.label.framework.printLabelAsync = function(o, t, r, g) {
    ...
    dymo.label.framework.getPrintersAsync().then(function(e) {
        ...
        if (goog.isDefAndNotNull(e))
            return ASSUME_MOBILE || e.isNetworkPrinter() ? printLabelToNetworkPrinter(e, t, r, g) : _createFramework().printLabelAsync(e.name, t, r, g);
...
dymo.label.framework.printLabelAndPollStatus = function(e, o, t, r, g, n) {
    function i(e) {
        var o;
        g(s, e) && (o = new goog.async.Delay(function() {
            s.getStatus(i),
            o.dispose()
        }
        ,n)).start()
...
dymo.label.framework.printLabelAndPollStatusAsync = function(e, o, t, r, g, n) {
    return dymo.label.framework.printLabel2Async(e, o, t, r).then(function(t) {
        function r(e) {
            var o;
            g(t, e) && (o = new goog.async.Delay(function() {
                t.getStatus(r),
                o.dispose()
            }
            ,n)).start()
...
dymo.label.framework.is550PrinterAsync = function(e) {
    return _createFramework().is550PrinterAsync(e).then(function(e) {
        return e
    })
}
,
...
dymo.label.framework.getConsumableInfoIn550PrinterAsync = function(e) {
    return _createFramework().getConsumableInfoIn550PrinterAsync(e).then(function(e) {
        return e
    })
}
;
